 ...
 * <a href="http://code.google.com/p/xxhash/">the original LZ4 C
 * implementation</a>.
 * <li>a {@link #safeInstance() safe Java} instance which is a pure Java port of
 * the original C library,</li>
...
public final class XXHashFactory
{
    ...
    /**
     * Return a {@link XXHashFactory} that returns {@link XXHash32} instances
     * that are native bindings to the original C API.
     * <p>
    ...
    /**
     * Return a {@link XXHashFactory} that returns {@link XXHash32} instances
     * that are written with Java's official API.
     */
    ...
    /**
     * Return a {@link XXHashFactory} that returns {@link XXHash32} instances
     * that may use {@link sun.misc.Unsafe} to speed up hashing.
     */
    ...
    /**
     * Return the fastest available {@link XXHashFactory} instance which does
     * not rely on JNI bindings. It first tries to load the
