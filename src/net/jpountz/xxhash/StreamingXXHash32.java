 ...
 * sh32.update(buf, off, len); return sh32.getValue(); }
 * </pre>
 * <p>
...
public abstract class StreamingXXHash32
{
    ...
    /**
     * Return a {@link Checksum} view of this instance. Modifications to the
     * view will modify this instance too and vice-versa.
     */
