...
public final class LZ4BlockInputStream extends FilterInputStream
{
     ...
     * use
     * @param checksum the {@link Checksum} instance to use, must be equivalent
     * to the instance which has been used to write the stream
     */
    ...
    /**
     * Create a new instance which uses the fastest {@link LZ4Decompressor}
     * available.
     *
