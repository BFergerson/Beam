...
public abstract class LZ4Decompressor
{
    ...
    /**
     * Uncompress <code>src[srcOff:]</code> into
     * <code>dest[destOff:destOff+destLen]</code> and return the number of bytes
     * read from <code>src</code>. <code>destLen</code> must be exactly the size
