...
public abstract class LZ4Compressor
{
    ...
    /**
     * Return the maximum compressed length for an input of size
     * <code>length</code>.
     */
     ...
     * length.
     *
     * This method will throw a {@link LZ4Exception} if this compressor is
     * unable to compress the input into less than <code>maxDestLen</code>
     * bytes. To prevent this exception to be thrown, you should make sure that
